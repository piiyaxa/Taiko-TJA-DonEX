...
//                    }
        ...
        public Cシステムサウンド bgmたたいてスタート = null;
        public Cシステムサウンド bgmぴこん = null;
        public Cシステムサウンド soundこれで始める = null;
        //add
        ...
        public Cシステムサウンド this[Eシステムサウンド sound]
        {
            get
            {
                switch (sound)
                {
                    ...
                    case Eシステムサウンド.BGMたたいてスタート:
                        return this.bgmたたいてスタート;
                    ...
                    case Eシステムサウンド.SOUNDこれで始める:
                        return this.soundこれで始める;
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.bgmたたいてスタート = new Cシステムサウンド(@"Sounds\たたいて.wav", false, false, true, ESoundGroup.Voice);
            this.bgmぴこん = new Cシステムサウンド(@"Sounds\ぴこん.wav", false, false, true, ESoundGroup.Voice);
            ...
            this.soundこれで始める = new Cシステムサウンド(@"Sounds\これで.wav", false, false, true, ESoundGroup.Voice);
        ...
        public int SongLoading_Title_Y = 270;
